	...
	*/
	public void open() 
	{
		try 
		{
			...
			conn=DriverManager.getConnection("jdbc:mysql://www.icodedock.com/lvyousite?useSSL=false&serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8","lvyousite","lvyousite");
